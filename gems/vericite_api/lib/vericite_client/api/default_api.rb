...
module VeriCiteClient
  class DefaultApi
    ...
    def admin_consumer_new_consumer_key_create_post(new_consumer_key, consumer, consumer_secret, consumer_data, opts = {})
      data, status_code, headers = admin_consumer_new_consumer_key_create_post_with_http_info(new_consumer_key, consumer, consumer_secret, consumer_data, opts)
      return data
    end
    ...
    def admin_consumer_new_consumer_key_create_post_with_http_info(new_consumer_key, consumer, consumer_secret, consumer_data, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: DefaultApi#admin_consumer_new_consumer_key_create_post ..."
      end
      
      # verify the required parameter 'new_consumer_key' is set
      fail "Missing the required parameter 'new_consumer_key' when calling admin_consumer_new_consumer_key_create_post" if new_consumer_key.nil?
      
      # verify the required parameter 'consumer' is set
      fail "Missing the required parameter 'consumer' when calling admin_consumer_new_consumer_key_create_post" if consumer.nil?
      
      # verify the required parameter 'consumer_secret' is set
      fail "Missing the required parameter 'consumer_secret' when calling admin_consumer_new_consumer_key_create_post" if consumer_secret.nil?
      
      # verify the required parameter 'consumer_data' is set
      fail "Missing the required parameter 'consumer_data' when calling admin_consumer_new_consumer_key_create_post" if consumer_data.nil?
      
      # resource path
      local_var_path = "/admin/consumer/{newConsumerKey}/create".sub('{format}','json').sub('{' + 'newConsumerKey' + '}', new_consumer_key.to_s)
      ...
      # http body (model)
      post_body = @api_client.object_to_http_body(consumer_data)
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DefaultApi#admin_consumer_new_consumer_key_create_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param [Hash] opts the optional parameters
    # @return [ConsumerResponse]
    def admin_consumer_new_consumer_key_update_put(new_consumer_key, consumer, consumer_secret, consumer_data, opts = {})
      data, status_code, headers = admin_consumer_new_consumer_key_update_put_with_http_info(new_consumer_key, consumer, consumer_secret, consumer_data, opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(ConsumerResponse, Fixnum, Hash)>] ConsumerResponse data, response status code and response headers
    def admin_consumer_new_consumer_key_update_put_with_http_info(new_consumer_key, consumer, consumer_secret, consumer_data, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: DefaultApi#admin_consumer_new_consumer_key_update_put ..."
      end
      
      # verify the required parameter 'new_consumer_key' is set
      fail "Missing the required parameter 'new_consumer_key' when calling admin_consumer_new_consumer_key_update_put" if new_consumer_key.nil?
      
      # verify the required parameter 'consumer' is set
      fail "Missing the required parameter 'consumer' when calling admin_consumer_new_consumer_key_update_put" if consumer.nil?
      
      # verify the required parameter 'consumer_secret' is set
      fail "Missing the required parameter 'consumer_secret' when calling admin_consumer_new_consumer_key_update_put" if consumer_secret.nil?
      
      # verify the required parameter 'consumer_data' is set
      fail "Missing the required parameter 'consumer_data' when calling admin_consumer_new_consumer_key_update_put" if consumer_data.nil?
      
      # resource path
      local_var_path = "/admin/consumer/{newConsumerKey}/update".sub('{format}','json').sub('{' + 'newConsumerKey' + '}', new_consumer_key.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'ConsumerResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DefaultApi#admin_consumer_new_consumer_key_update_put\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
